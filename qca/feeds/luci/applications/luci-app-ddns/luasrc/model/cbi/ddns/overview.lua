...
if show_hints or need_update or not SYS.init.enabled("ddns") then
	...
	if show_hints then
		...
		dv.titleref = DISP.build_url("admin", "application", "ddns", "hints")
		dv.rawhtml  = true
		dv.title = bold_on ..
