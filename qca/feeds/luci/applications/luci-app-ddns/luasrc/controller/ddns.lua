...
function index()
	...
	entry( {"admin", "application", "ddns"}, cbi("ddns/overview"), _("Dynamic DNS"), 59)
	entry( {"admin", "application", "ddns", "detail"}, cbi("ddns/detail"), nil ).leaf = true
	entry( {"admin", "application", "ddns", "hints"}, cbi("ddns/hints",
		{hideapplybtn=true, hidesavebtn=true, hideresetbtn=true}), nil ).leaf = true
	entry( {"admin", "application", "ddns", "global"}, cbi("ddns/global"), nil ).leaf = true
	entry( {"admin", "application", "ddns", "logview"}, call("logread") ).leaf = true
	entry( {"admin", "application", "ddns", "startstop"}, call("startstop") ).leaf = true
	entry( {"admin", "application", "ddns", "status"}, call("status") ).leaf = true
end
